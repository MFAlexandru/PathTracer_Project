...
void load_to_mem(std::list<Sphere> *spheres_aux,
	...
	spheres_aux->push_back(Sphere(
		...
		// shininess, shininess strenght, reflectivity
		glm::vec3(100, 0, 0.0),
		// LUMINOSITY
		glm::vec3(0, 0, 0),
		// SHININESS
	...
	spheres_aux->push_back(Sphere(
		...
		4,
		// POSITION X Y Z
		cam_aux->position + cam_aux->w * 0.2f + cam_aux->u * 20.0f + cam_aux->v * 20.0f));
	...
	spheres_aux->push_back(Sphere(
		...
		4,
		// POSITION X Y Z
		cam_aux->position + cam_aux->w * 0.2f + cam_aux->v * -25.0f));
